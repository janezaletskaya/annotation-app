...
top_options = [
    "платье ДР", "платье КР", "куртка", "футболка", "кофта", "пиджак", "пальто", "рубашка ДР", "рубашка КР",
]

bottom_options = [
    "платье ДР", "платье КР", "шорты", "классические брюки", "джинсы", "юбка Д", "юбка К", "штаны",
]
...
shoes_options = [
    "туфли", "кроссовки", "кеды", "босоножки", "cандалии", "шлепанцы"
]

accessoires_options = [
    "зонт", "солнечные очки", "рюкзак", "сумка", "шарф", "перчатки"
]
